...
<div class="w3-top">
    <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
        ...
        <a href="index.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">create bill</a>
...
$strqry = "SELECT * FROM appointment ";
...
<button ><a href="../Secretary.html">back</a></button>
</body>
</html>
